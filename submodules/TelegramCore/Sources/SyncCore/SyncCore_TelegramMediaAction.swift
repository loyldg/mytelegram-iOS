...
public enum TelegramMediaActionType: PostboxCoding, Equatable {
    ...
    public init(decoder: PostboxDecoder) {
        ...
        case 57:
            self = .starGiftPurchaseOfferDeclined(gift: decoder.decodeObjectForKey("gift", decoder: { StarGift(decoder: $0) }) as! StarGift, amount: decoder.decodeCodable(CurrencyAmount.self, forKey: "amount") ?? CurrencyAmount(amount: .zero, currency: .stars), hasExpired: decoder.decodeBoolForKey("hasExpired", orElse: false))
        case 58:
